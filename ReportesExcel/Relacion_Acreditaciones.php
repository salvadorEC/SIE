...
$Ver_Acreditaciones= "SELECT No_Lote,Ano_Acreditacion,Semestre_Alumno,No_Oficio,Periodo,Nombre_Alumno,Matricula_Acreditacion,Nombre_Alumno,Carrera_Alumno,Fecha_Acreditacion,Idioma,Nivel_Acreditacion FROM $ACREDITACIONES JOIN $ALUMNOS ON  Matricula_Alumno = Matricula_Acreditacion ORDER BY Nombre_Alumno ASC  ";
                          ...
                          while ($renglon = mysqli_fetch_array($Result_Ver_Acreditaciones))
                             {
                               			...
                               			// ################# MOSTRAR FECHA LARGA ##########
                                    $Fecha_Por_Lote = $renglon['Fecha_Acreditacion'];

																		$exploded = multiexplode(array("-","T"),$Fecha_Por_Lote);
                               ...
                               $objPHPExcel->setActiveSheetIndex(0)
                                           ...
                                           ->setCellValue("I$i", '=CONCATENATE("'.$exploded[2].'"," ","'.$exploded[1].'"," ","'.$exploded[0].'")')
