<?php
 ...
 ##########################################################
  ...
  $ver_Examenes_D = "SELECT Id_ExamenD,Fecha_ExamenD,Matricula_AlumnoD,Nombre_Alumno,Nivel_ExamenD,No_Recibo_ED FROM $ALUMNOS INNER JOIN $EXAMENES_DIAGNOSTICO ON Matricula_Alumno = Matricula_AlumnoD WHERE Fecha_ExamenD like '%".$Fecha_ExamenD."%';";
 ...
 <html>
   ...
   <section>
     <div class="jumbotron">
       ...
       <h2>EDITAR NIVELES LOTE FECHA: <? echo "$exploded[2]/$exploded[1]/$exploded[0]";?></h2>
     </div>
   </section>
