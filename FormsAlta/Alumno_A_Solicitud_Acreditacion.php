      ...
      <form class="form-horizontal" action="../BibliotecaPHP/Alta_Alumno_De_Solicitud_Acreditaciones.php" method="post">
        <div class="form-group"> <!--Agrupar Label y El Input-->
          ...
          <div class="col-sm-8"> <!--Input-->
            <input class="form-control" type="text" name="Matricula_Alumno" value ="<?php echo $Matricula_De_Comprobacion ?>" placeholder="Ej, 01134815" required="required" maxlength="8">
          </div>
        </div>
